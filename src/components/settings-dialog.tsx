...
export function SettingsDialog() {
    ...
    const updateConfig = (section: 'openai' | 'gemini' | 'azure' | 'glm' | 'minimax' | 'qwen', key: string, value: string) => {
        if (section === 'openai') {
            // Handle OpenAI separately via updateOpenAIInstance usually, assuming no direct top-level openAI updates here
            return;
        }
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="glm">ZhipuAI (GLM)</SelectItem>
                                    ...
                                    <div className="space-y-3 animate-in fade-in slide-in-from-top-2">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    type={showApiKey ? "text" : "password"}
                                                    value={config.glm?.apiKey || ''}
                                                    onChange={(e) => updateConfig('glm' as any, 'apiKey', e.target.value)}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                value={config.glm?.baseUrl || ''}
                                                onChange={(e) => updateConfig('glm' as any, 'baseUrl', e.target.value)}
                                        ...
                                        <div className="space-y-2">
                                            <Label>Model</Label>
                                            <Input
                                                value={config.glm?.model || ''}
                                                onChange={(e) => updateConfig('glm' as any, 'model', e.target.value)}
                                                placeholder="glm-4"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3 animate-in fade-in slide-in-from-top-2">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    type={showApiKey ? "text" : "password"}
                                                    value={config.minimax?.apiKey || ''}
                                                    onChange={(e) => updateConfig('minimax' as any, 'apiKey', e.target.value)}
                                        ...
                                        <div className="space-y-2">
                                            <Label>Base URL</Label>
                                            <Input
                                                value={config.minimax?.baseUrl || ''}
                                                onChange={(e) => updateConfig('minimax' as any, 'baseUrl', e.target.value)}
                                        ...
                                        <div className="space-y-2">
                                            <Label>Model</Label>
                                            <Input
                                                value={config.minimax?.model || ''}
                                                onChange={(e) => updateConfig('minimax' as any, 'model', e.target.value)}
                                    ...
                                    <div className="space-y-3 animate-in fade-in slide-in-from-top-2">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    onChange={(e) => updateConfig('qwen' as any, 'apiKey', e.target.value)}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => updateConfig('qwen' as any, 'baseUrl', e.target.value)}
                                        ...
                                        <div className="space-y-2">
                                            <Label>Model</Label>
                                            <Input
                                                value={config.qwen?.model || ''}
                                                onChange={(e) => updateConfig('qwen' as any, 'model', e.target.value)}
                        ...
                        <div className="flex flex-col items-center justify-center space-y-6 py-8 text-center bg-muted/30 rounded-lg border">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 w-full sm:w-auto px-4 sm:px-0">
                                <Button variant="outline" asChild className="gap-2 w-full sm:w-auto">
                                    <a href="https://github.com/panjingxi/ai-wrong-notebook" target="_blank" rel="noopener noreferrer">
                                ...
                                <Button variant="outline" asChild className="gap-2 w-full sm:w-auto">
                                    <a href="https://github.com/panjingxi/ai-wrong-notebook/releases" target="_blank" rel="noopener noreferrer">
                                ...
                                <Button variant="outline" asChild className="gap-2 w-full sm:w-auto">
                                    <a href="https://github.com/panjingxi/ai-wrong-notebook/issues" target="_blank" rel="noopener noreferrer">
                            ...
                            <p className="text-xs text-muted-foreground mt-8">
                                {t.settings?.about?.copyright || "© 2025 PanJingxi. All rights reserved."}
                            </p>
                        </div>
                    </TabsContent>
