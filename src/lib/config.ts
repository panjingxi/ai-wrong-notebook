...
export interface AppConfig {
    aiProvider: 'gemini' | 'openai' | 'azure' | 'glm' | 'minimax' | 'qwen';
    ...
    if (fs.existsSync(CONFIG_FILE_PATH)) {
        try {
            ...
            return {
                ...
                glm: { ...DEFAULT_CONFIG.glm, ...userConfig.glm },
                minimax: { ...DEFAULT_CONFIG.minimax, ...userConfig.minimax },
...
export function updateAppConfig(newConfig: Partial<AppConfig>) {
    ...
    const updatedConfig = {
        ...
        glm: { ...currentConfig.glm, ...newConfig.glm },
        minimax: { ...currentConfig.minimax, ...newConfig.minimax },
